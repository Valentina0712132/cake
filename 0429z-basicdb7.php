...
<html>
    ...
    <body>
        <form id="f1" name="f1" method="get" action='0429z-basicdb7.php'>
    <table border='0' width='1000'>
        ...
        for($i=0;$i<$len1;$i++)
        {
            ...
            if(!empty($_GET['t1']))
            {
                ...
                {
                    echo "<td><a href='0429z-basicdb7.php?t1=".$data2[$i][0]."'>編輯</a></td>";
                }
            }
            else
            {
            ...
            echo "<td><a href='0429z-basicdb7.php?t1=".$data2[$i][0]."'>刪除</a></td>";
            echo "</tr>";
        }
        echo "</tbody>";
